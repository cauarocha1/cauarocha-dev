...
Documentação inicial concluída e primeira implementação funcional criada.
...
- ordem final das seções da home
- estrutura exata de serviços da RDS
- textos finais em PT e EN
- refinamento das imagens dos projetos que ainda não possuem capturas
...
- metadados, canonical, alternates de idioma, schema Person, sitemap e robots
- headers de segurança e cache para Cloudflare Pages
- eventos preparados para GitHub, LinkedIn, e-mail, projeto e troca de idioma
- build estático e typecheck validados
...
Sempre que surgir dúvida pequena:

1. preferir o contexto já fechado
2. evitar inventar dados
3. registrar a pendência se afetar credibilidade

## Próximos passos naturais

- revisar a primeira versão visual
- inserir assets adicionais dos projetos
- publicar a primeira versão em Cloudflare Pages
